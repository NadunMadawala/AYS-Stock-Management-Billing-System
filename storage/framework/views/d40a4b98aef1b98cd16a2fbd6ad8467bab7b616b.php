    ...
    <script>
        $(document).ready(function () {
            ...
            $('#filterBtn').click(function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('clothes.filter')); ?>",
                    type: "GET",
            ...
            $('#downloadBtn').click(function () {
                ...
                location.href = "<?php echo e(route('clothes.export')); ?>?from_date=" + fromDate + "&to_date=" + toDate;
            });
        });
...
<?php echo $__env->make('dashboard.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Cotton Street Stock Management\cotton-street-stock-management\resources\views/dashboard/cs-stock-report/current-stock-report.blade.php ENDPATH**/ ?>