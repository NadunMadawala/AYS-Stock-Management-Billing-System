...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const categoryChartOptions = {
        ...
        labels: ['Casual Wear', 'Ethnic Wear', 'Western Wear', 'Accessories', 'Bedsheet','Others'],
        colors: ['#1a237e', '#283593', '#3949ab', '#5c6bc0','#5678cb', '#7986cb'],
        plotOptions: {
            pie: {
                donut: {
                    size: '75%',
...
<?php echo $__env->make('dashboard.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\final project\AYS Biiling System\resources\views/dashboard/cs-main-dashboard/dashboard.blade.php ENDPATH**/ ?>