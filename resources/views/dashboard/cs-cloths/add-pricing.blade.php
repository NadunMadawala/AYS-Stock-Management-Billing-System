                ...
                <div class="col-md-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body px-0">
                            <form method="POST" action="{{ route('clothes.pricing.store', 1) }}" class="form-horizontal">
                                @csrf
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($dummySizes as $index => $size)
                                            <tr>
                                                <td class="align-middle font-weight-bold">{{ $size['size'] }}</td>
