...
?>
        ...
        <div class="c-sidebar-brand">
            <h4 class="c-sidebar-brand-full"> AYS bedsheets & clothing </h4>
            <h4 class="c-sidebar-brand-minimized"> CS </h4>
            {{-- <img class="c-sidebar-brand-full" src="{{ asset('img/larg.jpg') }}" width="118" height="46" alt="CoreUI Logo">
            <img class="c-sidebar-brand-minimized" src="{{ asset('img/small.png') }}" width="118" height="46" alt="CoreUI Logo"> --}}
        </div>
