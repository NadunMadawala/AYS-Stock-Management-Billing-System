                            ...
                            <table id="stockTable" class="table table-bordered table-striped">
                                ...
                                @forelse($clothes as $cloth)
                                    <tr>
                                        ...
                                        <td>{{ $cloth->gender }} ({{ $cloth->common_formats }})</td>
                                        <td>{{ $cloth->color_name }}</td>
                                        <td>{{ $cloth->quantity }}</td>
                                        <td>{{ $cloth->stock_status }}</td>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#filterBtn').click(function () {
                ...
                $.ajax({
                    url: "{{ route('stock-in-and-out.filter') }}",
                    type: "GET",
            ...
            $('#downloadBtn').click(function () {
                ...
                location.href = "{{ route('stock-in-and-out.export') }}?from_date=" + fromDate + "&to_date=" + toDate;
            });
        });
