...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    public function run()
    {
        ...
        $this->insertLink('user,admin', 'Dashboard', '/dashboard', 'cil-applications');
//        $this->insertLink('user,admin', 'Create Category Form', '/create-category', 'cil-book');
//        $this->insertLink('user,admin', 'Category List', '/category-list', 'cil-list-rich');
//        $this->insertLink('user,admin', 'All Member Details', '/all-members', 'cil-wc');
//        $this->insertLink('user,admin', 'Addresses', '/address', 'cil-library-bookmark');
//        $this->insertLink('user,admin', 'Remove Category', '/remove-category', 'cil-list-rich');
        $this->beginDropdown('admin', 'Settings', 'cil-calculator');
            ...
            // $this->insertLink('admin', 'Add Address',              '/add-address');
            // $this->insertLink('admin', 'Person Details Recovery',              '/person-details-recovery');
